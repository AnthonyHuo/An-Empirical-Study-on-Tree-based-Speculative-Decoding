...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # self.kv_cache = KV_Cache(config=self.model_config, max_length=1024, device = "cpu", dtype = torch.float32)
        self.vocab_size = config.vocab_size
...
class InferenceEngine:
    def __init__(self, 
        ...
        self.model = LlamaForCausalLM.from_pretrained(model_name_or_path, torch_dtype=dtype, device_map=device)
        self.model.eval()
        self.model_config = self.model.config
...
class GraphInferenceEngine:
    def __init__(self, 
        ...
        self.dtype = dtype
        self.max_length = max_length
        self.engine = InferenceEngine(max_length=max_length, model_name_or_path='meta-llama/Llama-2-7b-hf', dtype=dtype, device=device)
    def clear_kv(self):
    ...
    def inference(self,
        ...
        return self.engine.model_run(inputs_embeds=inputs_embeds, storage_ids=storage_ids,
