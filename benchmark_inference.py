...
parser.add_argument('--T', type=int, default=10, help='time')
...
attn_mask=attn_mask[..., PREFIX_LEN: PREFIX_LEN + DEC_LEN,:PREFIX_LEN + DEC_LEN].clone()

for _ in range(WARM_UP):
    graph_engine.inference(input_ids=input_ids, storage_ids=storage_ids, position_ids=position_ids, attn_mask=attn_mask)
    graph_engine.set_kv_len(PREFIX_LEN)
